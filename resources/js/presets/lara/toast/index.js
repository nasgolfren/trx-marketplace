    ...
    container: ({ props }) => ({
        class: [
            ...
            // Colors
            {
                ...
                'bg-orange-100/70 dark:bg-orange-500/20': props.message.severity == 'warning',
            ...
            },
            {
                ...
                'border-orange-500 dark:border-orange-400': props.message.severity == 'warning',
            ...
            },
            {
                ...
                'text-orange-700 dark:text-orange-300': props.message.severity == 'warning',
